...
exports.exportFirestoreToCSV = void 0;
...
exports.exportFirestoreToCSV = functions
    ...
    corsHandler(req, res, async () => {
        try {
            ...
            console.log(`Snapshot obtained. Empty? ${snapshot.empty}. Size: ${snapshot.size}`);
            if (snapshot.empty) {
            ...
            res
                .status(500)
                .send(`Error exporting data: ${error instanceof Error ? error.message : "Unknown error"}`);
        }
    });
});
